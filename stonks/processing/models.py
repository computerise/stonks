...
def capital_asset_pricing_model(
    risk_free_rate: float, beta_of_investment: float, expected_return_of_market: float
) -> float:
    """
    ...
    expected_return_of_investment = (
        risk_free_rate + beta_of_investment * market_risk_premium
    )
